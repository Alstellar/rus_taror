...
DEFAULT_SETTINGS = {
    ...
    "price_tarot_transformation": ("70", "Цена Таро-расклада Личная трансформация"),
    "price_tarot_life_tree": ("120", "Цена Таро-расклада Дерево Жизни"),
    "price_tarot_wheel_fate": ("90", "Цена Таро-расклада Колесо судьбы"),
    "price_tarot_chakra": ("75", "Цена Таро-расклада Семь чакр"),
    "price_tarot_monthly": ("15", "Цена Таро-расклада Карта месяца"),
